...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public JWTAuthorizationFilter(AuthenticationManager authenticationManager, AuthUserService authService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,HttpServletResponse response,
        ...
        //Chama o metodo getAuthentication e retorna o usuário autenticado para
        // dar sequência na requisição
